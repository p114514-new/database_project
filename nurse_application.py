...
def  Modify_Responsibility_info(main_window):
    ...
    button2 = tk.Button(modify_window, text=" Modify patients room according to patient_id", command=lambda: modify_info())
...
def nurse_application_entry_window_with_info():
    ...
    button3 = tk.Button(main_window, text="Modify Responsibility info", command=lambda: Modify_Responsibility_info(main_window))
